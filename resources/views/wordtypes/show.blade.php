<x-guest-layout>
    ...
    <section class="w-full p-6 flex flex-col gap-4">
        ...
        <div class="flex flex-row gap-4 rounded-md
            ...
            <p class="p-2 w-5/6">{{ $wordtype->name }}</p>
        </div>
        ...
        <div class="flex flex-row gap-4 rounded-md
            ...
            <p class="p-2 w-5/6">{{ $wordtype->code }}</p>
        </div>
        ...
        <div class="flex flex-row gap-4 rounded-md
            ...
            <p class="p-2 w-5/6">{{ $wordtype->created_at }} </p>
        </div>
        ...
        <div class="flex flex-row gap-4 rounded-md
            ...
            <p class="p-2 w-5/6">{{ $wordtype->updated_at }} </p>
        </div>
        ...
        <p class="flex flex-row md:w-13 w-full rounded-md">
            ...
            <a href="{{ route('wordtypes.edit',$wordtype->id) }}"
